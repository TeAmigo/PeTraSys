...
public class QuoteHistory {
    ...
    public synchronized void onBar(long nextBarTime) {
        ...
        QuoteHistoryEvent quoteHistoryEvent = new QuoteHistoryEvent(QuoteHistoryEvent.EventType.NEW_BAR);
        synchronized (events) {
    ...
    public synchronized void update(double open, double high, double low, double close, long volume) {
        ...
        QuoteHistoryEvent quoteHistoryEvent = new QuoteHistoryEvent(QuoteHistoryEvent.EventType.MARKET_CHANGE);
        synchronized (events) {
            events.add(quoteHistoryEvent);
            events.notifyAll();
        }
