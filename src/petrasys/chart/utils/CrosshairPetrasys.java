 ...
 * 
 */
public class CrosshairPetrasys extends Crosshair implements Cloneable, PublicCloneable, Serializable {
  ...
  private boolean profitStopCrosshair = false;

  

  public boolean isProfitStopCrosshair() {
    return profitStopCrosshair;
  }

  public void setProfitStopCrosshair(boolean profitStopCrosshair) {
    this.profitStopCrosshair = profitStopCrosshair;
  }
...
//  }
   ...
   */
  public CrosshairPetrasys(double value) {
   ...
   */
  public CrosshairPetrasys(double value, Paint paint, Stroke stroke) {
    if (paint == null) {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof CrosshairPetrasys)) {
      return false;
    }
    CrosshairPetrasys that = (CrosshairPetrasys) obj;
