...
public class SubPlotHorizontalCrosshairLabelGenerator implements CrosshairLabelGenerator,
                                                        Serializable {
   ...
   */
  public SubPlotHorizontalCrosshairLabelGenerator(double subPlotValueIn) {
   ...
   *     permitted).
   */
  public SubPlotHorizontalCrosshairLabelGenerator(String labelTemplate,
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof SubPlotHorizontalCrosshairLabelGenerator)) {
      return false;
    }
    SubPlotHorizontalCrosshairLabelGenerator that
      = (SubPlotHorizontalCrosshairLabelGenerator) obj;
