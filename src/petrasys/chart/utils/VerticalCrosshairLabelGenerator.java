...
public class VerticalCrosshairLabelGenerator implements CrosshairLabelGenerator,
                                                        Serializable {
   ...
   */
  public VerticalCrosshairLabelGenerator(double valueIn) {
    //this("{0}", NumberFormat.getNumberInstance());
    this("{0}", DateOps.strFormat);
    value = valueIn;
  }
   ...
   *     permitted).
   */
  public VerticalCrosshairLabelGenerator(String labelTemplate,
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof VerticalCrosshairLabelGenerator)) {
      return false;
    }
    VerticalCrosshairLabelGenerator that
      = (VerticalCrosshairLabelGenerator) obj;
