 ...
 */
@Embeddable
public class Quotes1minPK implements Serializable {
  ...
  public Quotes1minPK(String symbol, int expiry, Date datetime) {
    this.symbol = symbol;
    this.expiry = expiry;
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof Quotes1minPK)) {
      return false;
    }
    Quotes1minPK other = (Quotes1minPK) object;
  ...
  public String toString() {
    return "petrasys.Quotes1minPK[symbol=" + symbol + ", expiry=" + expiry + ", datetime=" + datetime + "]";
  }
