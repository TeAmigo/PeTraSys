 ...
 */
public class CrossSectionDemo1DynCrossHair extends ApplicationFrame {
     ...
     */
    public CrossSectionDemo1DynCrossHair(String title) {
        super(title);
    ...
    public static void main(String[] args) {
        CrossSectionDemo1DynCrossHair demo = new CrossSectionDemo1DynCrossHair("JFreeChart: CrossSectionDemo1");
        demo.pack();
